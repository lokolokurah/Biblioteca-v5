...
public class ModeloTest {
	...
	@Test
	public void comenzarLlamaAlumnosComenzarLibrosComenzarPrestamosComenzar() {
		modelo.comenzar();
		InOrder orden = Mockito.inOrder(alumnosSimulados, librosSimulados, prestamosSimulados);
		orden.verify(alumnosSimulados).comenzar();
		orden.verify(librosSimulados).comenzar();
		orden.verify(prestamosSimulados).comenzar();
	}
	
	@Test
	public void terminarLlamaAlumnosTerminarLibrosTerminarPrestamosTerminar() {
		modelo.terminar();
		InOrder orden = Mockito.inOrder(alumnosSimulados, librosSimulados, prestamosSimulados);
		orden.verify(alumnosSimulados).terminar();
		orden.verify(librosSimulados).terminar();
		orden.verify(prestamosSimulados).terminar();
	}
